...
7) Iniciamos la aplicación: python app.py

        *** NOTA: Usar en Python3 para que se pueda escribir la ñ. Si se usa en python2 al intentar insertar un usuario que contenga la letra ñ se produccirá un error ***
        *** que se soluciona entrando a la base de datos y eliminando la ñ. Mientras no se haga ese cambio la aplicación no funcionará.                                 ***
...
En la parte inferior derecha de la tabla se ve un botón con el simbolo "+". Este botón se usa para añadir un usuario. Su funcionamiento es el siguiente:

    Al pinchar en el se muestra un popup por pantalla con un formulario que pide los siguientes datos:
        ...
        Boton reset: pinchando en este botón se limpiaran los datos introduccidos en el formulario.
